...
if(!class_exists('rtWPS')){
	...
	class rtWPS
	{
		...
		function __construct() {
			...
			$this->options = array(
				'settings' => 'rt_wps_settings',
				'version' => '1.0',
				'installed_version' => 'rt_wps_current_version'
			);
			...
			$this->assetsUrl = RT_WPS_PLUGIN_URL . '/assets/';
		...
		function render($viewName, $args = array(), $return = false) {
			...
			$viewPath = $rtWPS->viewsPath . $path . '.php';
